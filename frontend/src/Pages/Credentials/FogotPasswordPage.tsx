  ...
  return (
    <div className="bg-white w-full h-full flex items-center justify-center p-[6%]">
      ...
      >
        ...
        <button
          type="submit"
          className="active:shadow-none hover:cursor-pointer mt-1 h-10 px-4 py-2 bg-purple-600 text-white font-medium rounded-lg hover:shadow-purple-300 hover:shadow-md transition-all active:scale-95 disabled:pointer-events-none disabled:opacity-60 flex justify-center"
